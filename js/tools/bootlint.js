...
jQuery.extend({
	// Unique for each copy of jQuery on the common
...
setDocument = Sizzle.setDocument = function( node ) {
	...
	if ( (support.qsa = rnative.test( doc.querySelectorAll )) ) {
		...
		assert(function( div ) {
			...
			// In-common `selector#id sibing-combinator selector` fails
	...
	add: function( elem, types, handler, data, selector ) {
		...
		if ( !(eventHandle = elemData.handle) ) {
			eventHandle = elemData.handle = function( e ) {
				...
				// when an event is called after a common has unloaded
...
(function (exports) {
    ...
    if (IN_NODE_JS) {
        ...
        (function () {
             ...
             * @param {boolean} [alertOpts.problemFree=true] Show one alert() at the end of linting if the common has no lint problems?
             * @returns {undefined} Nothing
             */
